...
module.exports = function (grunt) {
  ...
  grunt.registerTask('docs', ['docs-css', 'lint-docs-css', 'docs-js', 'lint-docs-js', 'clean:docs', 'copy:docs', 'build-glyphicons-data', 'build-material-icons-data', 'build-customizer']);
